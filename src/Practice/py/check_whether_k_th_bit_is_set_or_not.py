...
A bit is called set if it is 1. Position of set bit '1' should be indexed starting with 0 
...
checkKthbit that takes n and k as parameters and returns either true (if kth bit is set)
