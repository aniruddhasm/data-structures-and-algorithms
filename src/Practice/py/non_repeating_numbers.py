...
numbers exist in pairs whereas the other two number occur exactly 
...
as input parameter and returns a list of two numbers which occur exactly once in the array. 
